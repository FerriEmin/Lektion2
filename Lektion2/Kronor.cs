    ...
    public class Kronor
    {
        ...
        public Kronor Add(Kronor other)
        {
            var temp = (this.ÖrenPart() + other.ÖrenPart()) + 
                //Added an * 100 to this.KronorPart()
        ...
        {
            //Modified the position of other.ÖrenPart() and other.KronorPart()
            var temp = (this.ÖrenPart() - other.ÖrenPart()) + 
                //Changed 10 to 100 in other.ÖrenPart()
                (this.KronorPart() * 100 - other.KronorPart() * 100);
            var tempKronor = temp / 100;
            var tempÖren = temp % 100;
        ...
        {
            //Corrected!! Was grater than zero!! Should be Lesser than zero!!
            return öre < 0;
        }
